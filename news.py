...
topHeadlines = newsApi.get_top_headlines(country = userCountry, page_size = 5) #Gets top headlines from users country
...
print("Top headlines provided by newsapi.org")
